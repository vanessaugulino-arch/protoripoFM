...
export const INDICATOR_META: Record<IndicatorId, IndicatorMeta> = {
  ...
  frete:     { label: 'Frete Marítimo (WCI)',           fonte: 'Drewry',    valor: 'US$ 2.847 /FEU',   desc: 'World Container Index — custo médio por contêiner de 40 pés. Alta no frete eleva o custo de importação de produto acabado e insumos, pressionando o OTB e a margem bruta.',                                   variacao: '+12,3%', positivo: false },

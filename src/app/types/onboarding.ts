...
export const SEGMENT_LABELS: Record<SegmentId, string> = {
  ...
  acc_joia_fem:  'Acessórios Feminino (Jóias, semijóias, bijuterias e óculos)',
  acc_joia_masc: 'Acessórios Masculino (Jóias, semijóias, bijuterias e óculos)',
  acc_joia_inf:  'Acessórios Infantil (Jóias, semijóias, bijuterias e óculos)',
